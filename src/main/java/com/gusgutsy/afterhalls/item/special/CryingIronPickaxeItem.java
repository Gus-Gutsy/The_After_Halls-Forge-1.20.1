...
public class CryingIronPickaxeItem extends PickaxeItem implements ICryingIron {

    public CryingIronPickaxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
