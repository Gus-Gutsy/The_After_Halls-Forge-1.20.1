...
public enum AHArmorMaterials implements ArmorMaterial {
    ...
    AHArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound,
    ...
    public String getName() {
        return AfterHalls.MOD_ID + ":" + this.name;
    }
